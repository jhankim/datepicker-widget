...
export default class DatePickerB extends React.Component {
  constructor() {
    super();
  ...
  render() {
    return (
      <React.Fragment>
        <h1>Version B</h1>
        <p>
          The following date picker allows the user to select any range of
          dates, but does not allow less than 3 nights
        </p>
